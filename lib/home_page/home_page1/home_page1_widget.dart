...
/// Home page of an art-centric marketplace with grid view and title and price
/// under each card.
///
/// a search bar on top. and a bottom navbar that has from left to right: home
/// icon, search icon, add button icon, heart icon for favorites, and profile
/// icon.
