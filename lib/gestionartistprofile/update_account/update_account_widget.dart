...
class UpdateAccountWidget extends StatefulWidget {
  ...
  static String routePath = '/updateAccount';
                ...
                child: StreamBuilder<List<AccountRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return FFButtonWidget(
                      onPressed: () async {
                        await buttonAccountRecord!.reference
                            .update(createAccountRecordData(
                          photoUrl: buttonAccountRecord.photoUrl,
                          nomUtilisateur: buttonAccountRecord.nomUtilisateur,
                          email: buttonAccountRecord.email,
                          motDePasse: buttonAccountRecord.motDePasse,
                        ));
