...
class ReadAccountWidget extends StatefulWidget {
  const ReadAccountWidget({super.key});

  static String routeName = 'ReadAccount';
  static String routePath = '/readAccount';

  @override
  State<ReadAccountWidget> createState() => _ReadAccountWidgetState();
}

class _ReadAccountWidgetState extends State<ReadAccountWidget> {
  late ReadAccountModel _model;
