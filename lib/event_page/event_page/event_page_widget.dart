                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'From   ${dateTimeFormat("d/M H:mm", widget.eventDoc?.startDate)}  To    ${dateTimeFormat("d/M H:mm", widget.eventDoc?.endDate)}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Manrope',
                            ...
                            if (widget.eventDoc?.maxGuestsNumber.toString() !=
                                '0')
                              StreamBuilder<EventRecord>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final buttonEventRecord = snapshot.data!;
                                  ...
                                  return FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'You were added to the list of Participants',
                                            style: TextStyle(
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                      .primaryText,
                                          ...
                                          backgroundColor: Color(0xFF0ECA69),
                                        ),
                                      );
