      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              context.pushNamed(EventMainPageWidget.routeName);
            },
          ),
          title: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Material(
                              ...
                              child: Container(
                                width: MediaQuery.sizeOf(context).width * 1.146,
                                decoration: BoxDecoration(
                            ...
                            Material(
                              ...
                              child: Container(
                                width: MediaQuery.sizeOf(context).width * 1.143,
                                decoration: BoxDecoration(
                                  color: FlutterFlowTheme.of(context)
                                      .primaryBackground,
                                  borderRadius: BorderRadius.circular(16.0),
                                ...
                                child: Padding(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final columnMapNinjaApiResponse =
                                          snapshot.data!;
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: FlutterFlowStaticMap(
                                              location:
                                                  functions.latlngConverter(
                                                      MapNinjaApiCall.lat(
                                                        columnMapNinjaApiResponse
                                                            .jsonBody,
                                                      )?.toList(),
                                                      MapNinjaApiCall.lng(
                                                        columnMapNinjaApiResponse
                                                  ...
                                                  builder:
                                                    ...
                                                    return AlertDialog(
                                                      title: Text(
                                                          'Bad City or Country'),
                                                      content: Text(
                                                          'try to enter a valid country and city '),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () =>
                                                              Navigator.pop(
                  ...
                  child: Padding(
                    ...
                    child: StreamBuilder<List<EventRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<EventRecord> buttonEventRecordList =
                            snapshot.data!;
                        // Return an empty Container when the item does not exist.
                        if (snapshot.data!.isEmpty) {
                          return Container();
                        }
                        final buttonEventRecord =
                            buttonEventRecordList.isNotEmpty
                                ? buttonEventRecordList.first
                                : null;
                        ...
                        return FFButtonWidget(
                            ...
                            if ((_model.textController1.text != '') &&
                                ...
                                ((dateTimeFormat("d/M H:mm",
                                    ...
                                    (dateTimeFormat("M/d H:mm",
                                                _model.datePicked2) !=
                                            '')) &&
                                (_model.maxGuestsTextController.text != '0')) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'Your event is added successful',
                                    style: TextStyle(
                                      color: FlutterFlowTheme.of(context)
                                          .primaryText,
                                    ),
                              ...
                              await EventRecord.collection.doc().set({
                                ...
                                ...mapToFirestore(
                                  {
                                    'userParticipants': [currentUserReference],
                                  },
                                ),
                              });

                              await UserEventRecord.collection.doc().set({
                                ...createUserEventRecordData(
                                  userRef: currentUserReference,
                                ),
                                ...mapToFirestore(
                                  {
                                    'EventList': [buttonEventRecord?.reference],
                                  },
                                ),
                              });
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  ...
                                  duration: Duration(milliseconds: 4000),
                                  backgroundColor: Color(0xFFFC0D12),
                                ),
                              );
                            }
                          },
                          text: 'Create Event',
                          options: FFButtonOptions(
                            width: MediaQuery.sizeOf(context).width * 0.802,
                            height: 56.0,
                    ...
                    onPressed: () async {
                      if ((_model.textController1.text != '') &&
                          (_model.dropDownValue != null &&
                              _model.dropDownValue != '') &&
                          ((dateTimeFormat(
                                          "d/M H:mm", _model.datePicked1) !=
                                      '') &&
                              (dateTimeFormat(
                                          "M/d H:mm", _model.datePicked2) !=
                                      '')) &&
                          (_model.maxGuestsTextController.text != '0')) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
